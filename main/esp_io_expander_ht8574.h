...
//adaptación de HT8574 clon chino de PCF8574 en kincony
/**
 * Formato para la dirección de 8-bit :
 *
 ...
 *  └─────┘─────┘─────┘─────┘─────┘─────┘─────┘─────┘
 *     └────────┯────────┘     └─────┯──────┘
 *           (PCF8574)        (Seteado por HW en Koncony)
 */

#define ESP_IO_EXPANDER_I2C_HT8574_ADDRESS_010    (0x22)    //dirección del PCF8574 QUE LEE LAS ENTRADAS
#define ESP_IO_EXPANDER_I2C_HT8574_ADDRESS_100    (0x24)    //dirección del PCF8574 QUE ACTIVA LAS SALIDAS
