//enciende y apaga las salidas cada 500 ms cada una, va de una en una...
...
// Tarea principal para encender y apagar las salidas de la 1 a la 6 de una en una
void io_control_task(void *arg)
{
    ...
    while (true) {
        ...
        for (size_t i = 0; i < num_pins; i++) {
            ...
            vTaskDelay(pdMS_TO_TICKS(500));                     // Espera 1 segundo
        }
