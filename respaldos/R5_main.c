// se realiza test de encendido una sola vez y luego se leen las entradas repetidamente
//ciclos superpuestos de encendido y apagado con lectura de entradas
...
void io_control_task(void *arg)
{
    ...
    {
        ESP_LOGI(TAG, "Ciclo %d de %d", cycle + 1, cycle);
